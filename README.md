...
4. 「アプリケーションがポリシーによってこのファイルをブロックしました」と出て
   ...
   すると起動できます。2026年4月の更新（KB5083769）を適用した Windows 11 では、
   使い終わったら同じ画面で「オン」に戻せます（それより前の版では、**一度オフに
   すると Windows を入れ直すまで元に戻せません**）。オフにしたくない場合は
   Linux 版か、下の「ソースから動かす」をご検討ください。
